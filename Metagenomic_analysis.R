...
# stacked bars of equal heights. You may prefer to skip this option and continue from Line 280
# NOTE: If you use this option, you MUST follow the instruction in Line 334. We skipped this option in our study.
...
# IMPORTANT!!! IF you ran the optional re-normalization step in Line 272,
# please re-run the steps below before running the next intergroup significant difference
