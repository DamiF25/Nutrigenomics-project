...
forward_read="/mnt/scratch2/users/40319381/New_Kraken/Read_Files/${sample}_R1_001.fastq.gz"
reverse_read="/mnt/scratch2/users/40319381/New_Kraken/Read_Files/${sample}_R2_001.fastq.gz"
